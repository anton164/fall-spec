...
if [ $1 == "united" ]; then
  echo "united"
  echo "Vanilla MSTREAM"
  mstream/mstream -t 'data/united_time.txt' -n 'data/united_numeric.txt' -c 'data/united_categ.txt' -i 'data/united_ignore_record_score.txt' -o 'data/united_score.txt' -a 0.001
