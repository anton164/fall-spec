...
if [ $1 == "united" ]; then
  echo "united"
  echo "Vanilla MSTREAM"
  mstream/mstream -t 'data/united_time.txt' -n 'data/united_numeric.txt' -c 'data/united_categ.txt' -i 'data/united_ignore_score_record.txt' -o 'data/united_score.txt' -d 'data/united_decomposed.txt' -dp 'data/united_decomposed_percentage.txt' -a 0.8
